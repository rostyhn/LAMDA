const SINGLE_TRANSITION_RENDER_OPTIONS = ["Atom", "Superquadric", "Bonds"]
...
const PGUP = Keyboard.page_up
const PGDOWN = Keyboard.page_down
...
const HELP_ICON = FileIO.load(assetpath("$(@__DIR__)/res/question-mark-icon.png"))
