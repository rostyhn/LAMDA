...
function build_selection_window(
    ...
    inset_image(window, tGrid[1, 1], HELP_ICON, SCRATCHPAD_HELP; width=Makie.Fixed(15), height=Makie.Fixed(15), halign=1.0, valign=1.0, tellwidth=false, tellheight=false)
