...
function alignAtomPositions(referenceState::Int, atomPositions::Dict{Int,Matrix{Float64}})::Dict{Int,Matrix{Float64}}

    alignedAtomPositions = Dict{Int,Matrix{Float64}}()
