...
function computeTransitionInvariants(sequence::Vector{String}, atomPositions::Dict{String, Matrix{Float64}}, distanceMatrices::Dict{String, Matrix{Float64}})::Tuple{Dict{String, Vector}}
    ...
    unique = 1
    @time for sequenceStep in 1:(length(sequence)-1) 
